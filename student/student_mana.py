...
button = tk.Button(screen, text="Take input", command=lambda :takeNameInput())
button.grid(row=5, column=0, pady=30)

displayButton = tk.Button(screen, text="Display result", command=lambda :destroyscreenWindow())
