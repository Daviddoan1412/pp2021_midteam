...
appLabel = tk.Label(screen, text="Student Management System", fg="#06a099", width=35)
appLabel.config(font=("Sylfaen", 30))
appLabel.grid(row=0, columnspan=2, padx=(10,10), pady=(30, 0))

nameLabel = tk.Label(screen, text="Enter your name", width=40, anchor='w',
                    font=("Sylfaen", 12)).grid(row=1, column=0, padx=(10,0),
                                                pady=(30, 0))
collegeLabel = tk.Label(screen, text="Enter your college", width=40, anchor='w',
                        font=("Sylfaen", 12)).grid(row=2, column=0, padx=(10,0))
phoneLabel = tk.Label(screen, text="Enter your phone number", width=40, anchor='w',
                    font=("Sylfaen", 12)).grid(row=3, column=0, padx=(10,0))
addressLabel = tk.Label(screen, text="Enter your address", width=40, anchor='w',
                        font=("Sylfaen", 12)).grid(row=4, column=0, padx=(10,0))

nameEntry = tk.Entry(screen, width = 30)
collegeEntry = tk.Entry(screen, width = 30)
phoneEntry = tk.Entry(screen, width = 30)
addressEntry = tk.Entry(screen, width = 30)
...
button = tk.Button(screen, text="Take input", command=lambda : Student.takeNameInput())
button.grid(row=5, column=0, pady=30)

displayButton = tk.Button(screen, text="Display result", command=lambda :Student.destroyscreenWindow())
